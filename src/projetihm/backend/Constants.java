...
public class Constants {
    ...
    public static final String TABLE_PARIS = "TABLE_PARIS";
    public static final String TABLE_TOULOUSE = "TABLE_TOULOUSE";
    public static final String TABLE_EQUIPES = "TABLE_EQUIPES";
